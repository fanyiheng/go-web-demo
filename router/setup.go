...
import (
	...
	v1 "github.com/fanyiheng/go-web-demo/router/api/v1"
...
func Setup() *gin.Engine {
	...
	{
		group := api.HandlerGroup{Name: "account"}
		apiV1.GET("/account", group.Wrapper(v1.PageAccount))
		apiV1.GET("/account/:id", group.Wrapper(v1.GetAccount))
		apiV1.DELETE("account/:id", group.Wrapper(v1.Delete))
	}
